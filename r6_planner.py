"""R6 planner: dynamic source DAG -> research synthesis -> domain synthesis."""
        ...
        *,
        ...
        research_synthesis = PlanTask(
            ...
            arguments={
                ...
                "evidence_bundle": [{"from_task": query_id} for query_id in source_ids],
                "reference_date": reference_date,
            },
        ...
        plan = ExecutionPlan(
            ...
            tasks=[*source_tasks, research_synthesis, domain_synthesis],
        )
        validate_plan(plan)
        return plan
