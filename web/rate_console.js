(function () {
  ...
  const edgeElements = [];
  const scenarioBudget = () => ['deadline', 'late_result'].includes(byId('scenario').value) ? 1000 : ['live', 'approval_interactive', 'approval_durable_restart', 'approval_durable_stale'].includes(byId('scenario').value) ? 120000 : 30000;
