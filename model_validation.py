"""V2 model-response validation helpers.

The model is untrusted input. Before the Runtime acts on a normalized model
response, it validates the response shape. This module stays deterministic and
provider-agnostic.
"""
