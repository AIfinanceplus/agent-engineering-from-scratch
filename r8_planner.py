"""R8 planner: same grounded research pipeline, professional domain-specific D1."""
...
class R8ResearchPlanner:
    ...
    def plan_from_blueprint(
        ...
        *,
        ...
        plan = ExecutionPlan(
            goal=f"[R8:{domain}] {blueprint.question}",
            tasks=[*source_tasks, research_synthesis, domain_decision, forecast_pack],
        )
        validate_plan(plan)
        return plan
